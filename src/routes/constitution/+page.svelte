...
<div class="constitution">
    ...
    <h3 class="noUnderscore clickable" on:click={() => goToSection(one)}>Section 1: Roster</h3>
        <h4 class="noUnderscore clickable" on:click={() => goToSection(oneOne)}>1.1 Positional Breakdown</h4>
         <h4 class="noUnderscore clickable" on:click={() => goToSection(oneTwo)}>1.2 Trading</h4>
            ...
            <h5 class="noUnderscore clickable" on:click={() => goToSection(oneTwoThree)}>1.2.2 Trade Deadline</h5>
            <h5 class="noUnderscore clickable" on:click={() => goToSection(oneTwoFour)}>1.2.3 Trade Restrictions</h5>
    ...
    <p>5 IR Spots (Player must be labeled as IR, Out, or Covid in the Sleeper App)</p>
    
    <h3 class="subSectionHeading" bind:this={oneTwo}>1.2 Trading</h3>
    
    <p>Trades- trades will lock before the start of the playoffs unless voted otherwise by the league, no trades will be vetoed unless the commish sees obvious collusion, any collusion will result in removal from the league with no refund, All trades will go to pending after accepted, both parties must say "approve/accept" in the chat then it will be pushed through</p>
    ...
    <div class="subBlock">
        ...
        <ul>
            <li>First Offense – Immediate removal from the league with no refund</li>
         </ul>
    ...
    <p>Rokkie drafts will consist of 4 rounds of drafting, with 4 hours alotted for each pick. </p>
    ...
    <p>League dues are set at {dues}$. Dues are collected through pinned Leaguesafe. All managers must be fully paid up before the start of regular season.</p>
